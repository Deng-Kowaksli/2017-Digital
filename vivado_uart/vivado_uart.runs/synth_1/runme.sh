...
HD_PWD='D:/vivado_experiment/vivado_uart/vivado_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_module.tcl
