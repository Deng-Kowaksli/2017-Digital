...
HD_PWD='D:/vivado_experiment/vivado_uart/vivado_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_module.tcl -notrace
