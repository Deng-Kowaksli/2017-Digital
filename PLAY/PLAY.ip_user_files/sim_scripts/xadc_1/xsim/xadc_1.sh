...
#
# Generated by Vivado on Tue May 09 15:22:43 +0800 2017
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: xadc_1.sh [-help]
# usage: xadc_1.sh [-lib_map_path]
# usage: xadc_1.sh [-noclean_files]
# usage: xadc_1.sh [-reset_run]
#
# ********************************************************************************************************

xv_path="M:/Xilinx/Vivado/2016.4"
...
# Script info
echo -e "xadc_1.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_1 xil_defaultlib.xadc_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim xadc_1 -key {Behavioral:sim_1:Functional:xadc_1} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xadc_1.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="M:/Xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_1.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xadc_1.sh -help\" for more information)\n"
    exit 1
  fi
