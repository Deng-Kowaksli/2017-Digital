...
#
# Generated by Vivado on Tue May 16 14:57:50 +0800 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../PLAY.srcs/sources_1/ip/clk_wiz_0_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../PLAY.srcs/sources_1/ip/clk_wiz_0_1" \
    "$ref_dir/../../../../PLAY.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
