...
HD_PWD='D:/vivado_experiment/vivado_adc/vivado_adc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vivado_adc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vivado_adc.tcl
