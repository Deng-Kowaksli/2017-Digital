...
HD_PWD='D:/vivado_experiment/vivado_adc/vivado_adc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vivado_adc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vivado_adc.tcl -notrace
